    ...
    <div className="flex flex-col gap-5 justify-center items-center h-full lg:h-screen ">
      ...
      <main className="bg-[var(--tertiary-color)] border-black border-2 p-7 flex rounded-md gap-7 lg:w-[1222px] text-[var(--primary-color)]">
        <section className="login-left h-[600px] w-[700px] flex justify-center">
          <span className="bg-[var(--quarternary-color)] size-full rounded-md border-black border-2 flex justify-center items-center">model here</span>
        </section>
        <section className="login-right lg:w-[450px] flex flex-col items-center justify-between ">
          ...
          <form className="p-6 bg-[var(--tertiary-color)] border-2 border-black rounded w-full h-[440px] flex justify-center flex-col gap-7 lg:text-xl relative " onSubmit={()=> {handleLogin(); handleLoginAlternative()}}>
